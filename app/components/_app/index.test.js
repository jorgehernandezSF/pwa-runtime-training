...
import {mountWithRouterAndCommerceAPI} from '../../utils/test-utils'
...
describe('PWA App', () => {
    test('When the browser goes offline it should send an offline analytics event', () => {
        ...
        mountWithRouterAndCommerceAPI(<PWAApp>Testing</PWAApp>)
    ...
    test('App component is rendered appropriately', () => {
        ...
        const wrapper = mountWithRouterAndCommerceAPI(
