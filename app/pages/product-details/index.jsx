...
import Carousel from 'pwa-kit-react-sdk/dist/components/carousel'
import CarouselItem from 'pwa-kit-react-sdk/dist/components/carousel/carousel-item'
import {
    HeaderBar,
    HeaderBarActions,
    HeaderBarTitle
} from 'pwa-kit-react-sdk/dist/components/header-bar'
import Image from 'pwa-kit-react-sdk/dist/components/image'
import Link from 'pwa-kit-react-sdk/dist/components/link'
import ListTile from 'pwa-kit-react-sdk/dist/components/list-tile'
import Price from 'pwa-kit-react-sdk/dist/components/price'
import Ratio from 'pwa-kit-react-sdk/dist/components/ratio'
    ...
    return (
        ...
        >
            {variationProperties.map(({name, value, swatches, orderable}) => {
                const swatchStyle = {
                    backgroundImage: swatches ? `url(${swatches[0].disBaseLink})` : ''
                }
                    ...
                    <div className="t-product-details__overview">
                        ...
                        >
                            {carouselImages.length > 0 ? (
                                carouselImages.map(({disBaseLink, alt}) => (
                                    <CarouselItem key={disBaseLink}>
                                        <Image
                                            {...imgProps}
                                            alt={alt}
                                            src={disBaseLink}
